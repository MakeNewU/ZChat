...
//    self.navigationItem.leftItemsSupplementBackButton = YES;
    ...
    backLabel.font = [UIFont systemFontOfSize:15.f];
    backLabel.text = @"返回";
    backLabel.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin;
    [backLabel sizeToFit];
    
    [leftBarView setBounds:CGRectMake(leftBarView.nim_left - 33, leftBarView.nim_top, leftBarView.nim_width, leftBarView.nim_height)];
    [backLabel setFrame:CGRectMake(-33, 0, backLabel.nim_width, backLabel.nim_height)];
    [leftBarView addSubview:backLabel];
...
- (void)setupTableView
{
    ...
    self.tableView.separatorStyle = UITableViewCellSeparatorStyleNone;//没有分隔线
...
- (void)onSendText:(NSString *)text atUsers:(NSArray *)atUsers
{
    ...
    if (atUsers.count) {
        ...
        apnsOption.apnsContent = [NSString stringWithFormat:@"%@在群里@你",me];
